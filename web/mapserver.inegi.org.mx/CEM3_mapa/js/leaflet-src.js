...
L.Control.Zoom = L.Control.extend({
	...
	onAdd: function (map) {
		...
		this._zoomInButton  = this._createButton(
		        ...
		        this.options.zoomFullText, this.options.zoomFullTitle,
		        zoomName + '-full',  container, this._resetView,  this);
	...
	_zoomIn: function (e) {
        ...
        _zoomFullButton: function (e) {
		this._map.setView(e.shiftKey ? 3 : 1);
	},
	...
	_zoomOut: function (e) {
        ...
        _resetView: function (e){
               // this._map.setView(new L.LatLng(23.78534, -86.83203), 4);
